  ...
  <div class="col-md-12">
    <div class="nav-tabs-custom">
      <ul style="font-weight: bold;" class="nav nav-tabs">
        <li id="tab_NuevaAuditoria" class="active"><a href="#tab_1_nueva" data-toggle="tab">NUEVA AUDITORIA</a></li>
        <li id="tab_Res"><a href="#tab_2_reportes" data-toggle="tab">REPORTES</a></li>
      </ul>
              ...
              <div class="row">
                ...
                <div class="col-md-2 col-sm-4">
                  ...
                  <div class="form-group">
                    ...
                    <select id="au_tipoDoc" name="au_tipoDoc" class="form-control selectRequerido select2" data-error="Seleccione Tipo Doc" style="width: 100%;">
                ...
                <div class="col-md-2 col-sm-4">
                  ...
                  <div class="form-group">
                    <input id="au_nombre" name="au_nombre" placeholder="Nombres" class="form-control requerido deshabilitarCopiado" type="text" data-error="Por favor ingresa Nombres">
                    <div class="input-group-icon"><i class="fa fa-user"></i></div>
                  </div>
                </div>
                ...
                <div class="col-md-2 col-sm-4">
                  <label for="">Tipo Notificacion</label>
                  <div class="form-group">
                    <select name="au_tpNotificacion" id="au_tpNotificacion" class="form-control selectRequerido" style="width: 100%;">
                      <option value="0">Seleccione</option>
                      <option value="1" selected>CORREO</option>
                      <option value="2">SMS</option>
                    </select>
                    <div class="input-group-icon"><i class="fa fa-bell"></i></div>
                  </div>
                </div>
                ...
                <div class="col-md-2 col-sm-4">
                  ...
                  <div class="form-group">
                    <input type="text" name="au_lesionado" id="au_lesionado" placeholder="Nombre del Lesionado" class="form-control requerido">
                    <div class="input-group-icon"><i class="fa fa-user"></i></div>
                  </div>
                </div>
                ...
                <div class="col-md-2 col-sm-4">
                  ...
                  <div class="form-group">
                    <input type="text" name="au_condicion" id="au_condicion" placeholder="Condicion" class="form-control requerido">
                    <div class="input-group-icon"><i class="fa fa-user"></i></div>
                  </div>
                </div>
        ...
        <div class="item-wrap">
          <form id="formConsultarAuditorias" data-toggle="validator" class="popup-form contactForm">
            <div class="row">
              ...
              <div class="col-sm-2">
                <label for="">Poliza</label>
                <div class="form-group deshabilitarCopiado">
                  <div class="help-block with-errors"></div>
              ...
              <div class="col-sm-2">
                ...
                <div class="form-group">
                  <div class="help-block with-errors"></div>
                  <select name="auc_aseguradora" id="auc_aseguradora" class="form-control selectRequerido" style="width: 100%;">
                    <option value="0">SELECCIONE</option>
                    <?php
                    mysqli_next_result($con);
                    $verAmparo = mysqli_query($con, "SELECT * FROM aseguradoras WHERE vigente='s';");
              ...
              <div class="col-md-1">
                <label for=""> </label>
                <button type="submit" id="verMisAuditorias" class="btn btn-block btn bg-navy">CONSULTAR <span class="fa fa-search"></span></a>
              </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header bg-primary">
          <h4 class="modal-title">EDITAR AUDITORIA
          ...
          <div class="container-fluid">
            <form id="frmEditarAuditoria" data-toggle="validator" method="POST">
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <input type="hidden" id="mau_idtipo_caso">
